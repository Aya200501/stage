...
import { DateRange, Widget, WidgetType, generateRandomString } from "@/utils";
...
const getWidgetSize = (type: WidgetType) => {
  ...
  //   if (type === "table" || type === "map")
  //     return { w: 4, h: 4, minW: 3, minH: 3 };
  if (type === "card") return { w: 3, h: 1, minW: 2, minH: 1 };
  //   if (type === "radarChart") return { w: 3, h: 3, minW: 3, minH: 3 };
  if (type === "video") return { w: 3, h: 3, minW: 3, minH: 3 };
  //   if (type === "signal") return { w: 2, h: 2, minW: 2, minH: 2 };
  //   if (type === "heatmap") return { w: 4, h: 4, minW: 3, minH: 3 };
  //   if (type === "qrCode") return { w: 2, h: 3, minW: 1, minH: 2 };
  else return { w: 2, h: 2 };
};
